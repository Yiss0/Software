// frontend/app/(auth)/index.tsx (MODIFICADO)
...
export default function SelectUserScreen() {
  ...
  // --- CAMBIO CLAVE ---
  // Esta función ahora es más simple. Ambas opciones llevan al login.
  // El archivo de login se llama 'login.tsx', no 'login-form.tsx'.
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.optionsContainer}>
          {/* Este botón ahora llama a navigateToLogin */}
          <TouchableOpacity 
            style={styles.optionCard}
            onPress={navigateToLogin} // <-- CAMBIO
          >
          ...
          {/* Este botón TAMBIÉN llama a navigateToLogin */}
          <TouchableOpacity 
            style={styles.optionCard}
            onPress={navigateToLogin} // <-- CAMBIO
          >
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 18, color: '#6B7280', textAlign: 'center', paddingHorizontal: 40, lineHeight: 26 },
  content: { flex: 1, paddingHorizontal: 20, justifyContent: 'flex-start', paddingTop: 20 },
  questionText: { fontSize: 24, fontWeight: '600', color: '#1F2937', textAlign: 'center', marginBottom: 16, lineHeight: 32 },
  optionsContainer: { flexDirection: 'row', gap: 16, justifyContent: 'space-between' },
  optionCard: { flex: 1, backgroundColor: '#FFFFFF', borderRadius: 20, padding: 24, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 12, elevation: 6, borderWidth: 2, borderColor: 'transparent', minHeight: 200, justifyContent: 'center' },
  optionIcon: { width: 64, height: 64, borderRadius: 32, backgroundColor: '#F8FAFC', alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
