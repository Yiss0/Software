...
export default function RegistroScreen() {
  ...
  const handleInputChange = (field: keyof typeof formData, value: string) => {
    if (field === 'telefono') {
      ...
      const cleaned = value.replace(/[^0-g]/g, '');
  ...
  const handleRegister = async () => {
    ...
    setLoading(true);
    try {
      // Usamos una definición más flexible para añadir el rol
      ...
      // Asumo que tu apiService.registerUser puede manejar el campo 'role'
          ...
          <View style={styles.inputContainer}>
           ...
           <View style={styles.inputContainer}>
             ...
             <View style={styles.inputWrapper}>
               ...
               <TouchableOpacity onPress={() => setShowPassword(!showPassword)} style={styles.eyeButton}><Eye size={20} color="#6B7280" strokeWidth={2} /></TouchableOpacity>
             </View>
           </View>
           <View style={styles.inputContainer}>
             ...
             <View style={styles.inputWrapper}>
               ...
               <TouchableOpacity onPress={() => setShowConfirmPassword(!showConfirmPassword)} style={styles.eyeButton}><Eye size={20} color="#6B7280" strokeWidth={2} /></TouchableOpacity>
             </View>
           </View>
...
const styles = StyleSheet.create({
    ...
    backButton: { position: 'absolute', left: 0, top: 0, width: 48, height: 48, borderRadius: 24, backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center', elevation: 4 },
    ...
    formContainer: { backgroundColor: '#FFFFFF', borderRadius: 20, padding: 28, marginBottom: 24, elevation: 8 },
    ...
    roleButton: { flex: 1, padding: 16, alignItems: 'center' },
